...
import AddItemToShoppingTrip from "../components/AddItemToShoppingTrip";
        ...
        <div>
          <div className="flex flex-col items-center" >
            <div className="pt-[70px]">
              <AddItemToShoppingTrip {...{tripId: router.query.tripId}}/>
            </div>
          </div>



          <div className="flex flex-col items-center mb-[50px] pt-[20px]" >
