...
export default function SharingList() {
  ...
  async function returnAllResults() {
    const params = {}
        ...
        <div className="flex flex-col items-center pt-[10px] pb-[10px]">
          <div className="flex flex-row items-center w-80 md:w-[500px]">
            <input
              ...
              className="border-2 border-[#F1592A] rounded-l-xl text-gray-700 h-[35px] w-[300px] md:w-[700px] text-left pl-1 md:pl-2 text-sm font-Quicksand font-bold"
              placeholder="Item Search (e.g. Lotion)"
              value={searchValue}
              onChange={(e) => {
            ...
            />
              ...
              <div className="bg-[#F1592A] rounded-r-xl h-[35px] w-[80px] md:w-[120px] flex flex-row items-center font-Quicksand font-bold">
                <button className="text-white h-[35px] w-[80px] md:w-[120px]" onClick={handleSearch}>
                  Search
                </button>

              </div>

              <div className="ml-[4px] bg-white border-2 border-[#F1592A] rounded-xl h-[35px] flex flex-row items-center">
                <button className="h-[35px] rounded-lg text-[11px] md:text-[13px] text-[#F1592A] h-[27px] w-[50px] md:w-[100px] font-Quicksand font-bold" onClick={()=>{setFilterModal(true)}}>
                  Filters
                </button>
              </div>
          ...
          <div className="text-black text-center pt-[15px]">
            Items others are Sharing:
            <br />
            {resultss == null && "No Search Results"}
          </div>
        </div>
      )}
